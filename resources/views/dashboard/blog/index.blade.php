                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <!-- table with dark -->
                                    <a href="{{ route('blog.create') }}" class="btn btn-primary mb-3 mx-3">Create new
                                        post</a>
                                            ...
                                            <tbody>
                                                @forelse ($blog as $row)
                                                    <tr class=" text-center">
                                                        ...
                                                        <td class=" w-50 text-bold-500">{{ $row->body }}</td>
                                                        <td class=" w-50 text-bold-500">{{ $row->body_en }}</td>
                                                        <td class=" text-bold-500">{{ $row->category->name }}</td>
                                                        <td class=" text-bold-500">{{ $row->users->name }}</td>
                                                        <td>
                                                            <img src="{{ asset('storage/' . $row->image_blog) }}"
