                        ...
                        <div class="col-12">
                            <div class="card">
                                ...
                                <div class="card-content">
                                    <!-- table with dark -->
                                    <a href="{{ route('image_slider.create') }}"
                                        class="btn btn-primary mb-3 mx-3">Create new post</a>
                                                    ...
                                                    <tr class=" text-center">
                                                        ...
                                                        <td>
                                                            <img src="{{ asset('storage/' . $row->images_slider) }}"
                                                                class="img-preview img-fluid mb-3" alt="">
                                                        </td>
                                                        <td class=" col-lg-3">
                                                            <a href="{{ route('image_slider.edit', $row->id) }}"
                                                                class="badge bg-warning"><span
                                                                    data-feather="edit"></span>
                                                            </a>
                                                            <form
                                                                action="{{ route('image_slider.destroy', $row->id) }}"
